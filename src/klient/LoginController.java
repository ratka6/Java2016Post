...
public class LoginController extends TabPane implements Initializable {
    ...
    private void register(String name, String address, String phoneNumber, String email) {
        ...
        ServerRequest request = new ServerRequest("register", user);
        sendRequest(request);
    }
    ...
    private void loginRequest(String username, String password) {
        ...
        ServerRequest request = new ServerRequest("login", data);
        sendRequest(request);
    }
    ...
    private void parseResponse(ServerResponse response) {
        ...
        } else if (response.responseName.equals("register")) {
            if (response.error == null) {
                if (response.object != null) {
    ...
    private void login() {
        ...
        loader.setLocation(getClass().getResource("KlientTabView.fxml"));
        TabPane login = null;
        try {
        ...
        ClientMenuController controller = loader.<ClientMenuController>getController();
